...
activity — walking, running, cycling, driving, or riding as a passenger. Arm it once and forget it:
...
- **Activity-aware recording** — uses on-device activity recognition to start a track when you
  ...
  you're stationary. Recognised modes: walking, running, cycling, driving, and taxi (passenger).
...
- **Timeline** — the Tracks tab reads like a diary: trips and the stays between them, grouped by
